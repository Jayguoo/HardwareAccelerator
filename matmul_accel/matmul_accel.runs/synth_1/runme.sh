...
HD_PWD='C:/Users/Jaygu/pp/HardwareAccelerator/matmul_accel/matmul_accel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matmul_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matmul_top.tcl
