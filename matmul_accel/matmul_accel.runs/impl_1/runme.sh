...
HD_PWD='C:/Users/Jaygu/pp/HardwareAccelerator/matmul_accel/matmul_accel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log matmul_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source matmul_top.tcl -notrace
